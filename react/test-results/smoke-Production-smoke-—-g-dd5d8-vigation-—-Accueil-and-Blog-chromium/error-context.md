...
- Name: smoke.spec.ts >> Production smoke — guivarche-demenagement.fr >> header navigation — Accueil and Blog
...
Call log:
  - waiting for getByRole('link', { name: /^accueil$/i }).first()
    - locator resolved to <a href="/" aria-label="Accueil" class="flex-shrink-0 py-4">…</a>
