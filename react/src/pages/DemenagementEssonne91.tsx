...
import { InterventionMapEssonne91 } from "../components/intervention-map";
...
const ESS91_PRICING_FACTORS = [
  ...
  },
  {
    ...
    label: "Distance",
    value: "Essonne",
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 91.",
  },
  {
...
const ESS91_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement en Essonne.",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement en Essonne (sous conditions)",
] as const;

/** Communes de l'Essonne — maillage interne. */
const ESS91_IDF_ZONES = [
  "Massy",
  "Palaiseau",
  "Orsay",
  "Gif-sur-Yvette",
...
const ESS91_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const ESS91_HERO_IMAGE = "/ville/essone.jpeg";
const PRIMARY_CTA_LABEL = "On s'occupe de tout – Demandez votre devis en Essonne";

function Essonne91IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={ESS91_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Essonne"
...
function Essonne91PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const ESS91_DESTINATION_FAQ = [
  {
    question: "Pourquoi faire appel à des déménageurs professionnels en Essonne ?",
    answer:
      "Faire appel à des professionnels vous permet de gagner du temps, d'éviter les contraintes logistiques et de protéger vos biens durant le transport. Notre équipe gère chaque étape pour un déménagement sans stress.",
  },
  {
    question: "Réalisez-vous des déménagements pour les particuliers et les entreprises ?",
    answer:
      "Oui, nous accompagnons aussi bien les particuliers que les professionnels. Que vous changiez de logement ou que vous transfériez vos bureaux, nous proposons des solutions adaptées à votre projet.",
  },
  {
    question: "Puis-je choisir une formule de déménagement sur mesure ?",
    answer:
      "Absolument. Nous proposons plusieurs formules allant du transport simple à la prise en charge complète, afin de répondre à vos besoins spécifiques et à votre budget.",
  },
  {
    question: "Comment préparez-vous les objets volumineux ou encombrants ?",
    answer:
      "Nos équipes disposent du matériel nécessaire pour déplacer les meubles lourds, électroménagers, coffres-forts et autres objets volumineux en toute sécurité, même dans les accès difficiles.",
  },
  {
    question: "Que se passe-t-il en cas d'imprévu le jour du déménagement ?",
    answer:
      "Nous anticipons chaque intervention grâce à une organisation rigoureuse. En cas d'imprévu, notre équipe met en place des solutions rapides pour limiter les retards et garantir le bon déroulement du déménagement.",
  },
  {
    question: "Effectuez-vous des déménagements vers d'autres départements ou régions ?",
    answer:
      "Oui, nous réalisons des déménagements au départ ou à destination de l'Essonne partout en France. Nous pouvons également organiser des déménagements longue distance selon votre projet.",
  },
  {
    question: "Quels sont les avantages d'obtenir un devis avant de déménager ?",
    answer:
      "Le devis permet d'estimer précisément le coût de votre déménagement, d'identifier les prestations nécessaires et d'éviter les mauvaises surprises. Il est gratuit et sans engagement.",
  },
] as const;

export default function DemenagementEssonne91() {
  usePageMeta(PAGE_META.demenagementEssonne91);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={ESS91_HERO_IMAGE}
              alt="Déménagement en Essonne — Guivarche"
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                ...
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Essonne – On S&apos;occupe de Tout, Vous Déménagez Sereinement
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Prestation clé en main pour un déménagement serein en Essonne avec Guivarche
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur de référence en Essonne
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous organisez un déménagement en Essonne ? Faites confiance à{" "}
                  <a
                    href="/"
                  ...
                  pour une prestation clé en main, adaptée à votre situation, que vous soyez à Évry-Courcouronnes,
                  Corbeil-Essonnes, Massy, Palaiseau ou Longjumeau.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre équipe prend en main l&apos;ensemble du processus : emballage de vos effets personnels,
                  démontage du mobilier, transport dans les règles de l&apos;art et installation soignée à votre nouvelle
                  adresse. Votre confort reste notre priorité absolue.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  L&apos;Essonne est un département aux multiples visages : vastes zones pavillonnaires, grands ensembles
                  en banlieue sud, secteurs ruraux et zones d&apos;activités périurbaines. Ces environnements hétérogènes
                  imposent une organisation sur-mesure pour chaque chantier.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre expérience en Essonne nous permet d&apos;adapter systématiquement notre méthode aux contraintes
                  locales, pour un déménagement maîtrisé de bout en bout dans toutes les communes du département.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, vous êtes entre de bonnes mains : suivi personnalisé, réactivité et engagement qualité
                  pour chaque déménagement en Essonne.
                </p>
              </div>
            </div>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement Essonne
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Une formule complète pour un déménagement maîtrisé en Essonne, de votre logement actuel
            ...
            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {ESS91_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <Essonne91PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {ESS91_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <Essonne91PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement en Essonne ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement en Essonne avec une protection complète de vos biens.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Essonne
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {ESS91_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={ESS91_DESTINATION_FAQ}
          compact
        />

        <InterventionMapEssonne91 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement en Essonne
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {ESS91_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < ESS91_IDF_ZONES.length - 1 ? (
