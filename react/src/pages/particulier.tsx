...
import { ArrowRight, Calendar, CheckCircle2, Globe, Home, Mail, MapPin, Phone, User, Boxes, Sofa, Package } from "lucide-react";
                ...
                <div className="rounded-3xl bg-white shadow-[0px_14px_45px_rgba(15,23,42,0.10)] border border-slate-100 p-6 sm:p-7">
                  ...
                  <div className="mt-6 grid gap-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="part-lastName" className="text-slate-900 mb-2 block">
                          Nom
                        </Label>
                        <div className="relative">
                      ...
                      <div>
                        <Label htmlFor="part-firstName" className="text-slate-900 mb-2 block">
                          Prénom
                        </Label>
                        <div className="relative">
                          <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "#CC922F" }} />
                    ...
                    <div>
                      <Label htmlFor="part-email" className="text-slate-900 mb-2 block">
                        Email
                      </Label>
                      <div className="relative">
                    ...
                    <div>
                      <Label htmlFor="part-phone" className="text-slate-900 mb-2 block">
                        Téléphone
                      </Label>
                      <div className="relative">
