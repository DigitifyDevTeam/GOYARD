...
import { InterventionMapValDeMarne94 } from "../components/intervention-map";
...
const VDM94_PRICING_FACTORS = [
  ...
  },
  {
    ...
    label: "Distance",
    value: "Val-de-Marne",
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 94.",
  },
  {
...
const VDM94_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement dans le Val-de-Marne.",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement dans le Val-de-Marne (sous conditions)",
] as const;

/** Communes du Val-de-Marne — maillage interne. */
const VDM94_IDF_ZONES = [
  "Vincennes",
  "Saint-Mandé",
  "Nogent-sur-Marne",
...
const VDM94_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const VDM94_HERO_IMAGE = "/ville/marne.png";
const PRIMARY_CTA_LABEL = "Disponible 7j/7 – Devis gratuit en Val-de-Marne";

function ValDeMarne94IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={VDM94_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Val-de-Marne"
...
function ValDeMarne94PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const VDM94_DESTINATION_FAQ = [
  {
    question: "Intervenez-vous dans tout le Val-de-Marne ?",
    answer:
      "Oui, nos équipes interviennent dans l'ensemble du Val-de-Marne, que vous soyez à Créteil, Vincennes, Saint-Maur-des-Fossés, Vitry-sur-Seine ou dans toute autre commune du département.",
  },
  {
    question: "Proposez-vous des déménagements urgents dans le Val-de-Marne ?",
    answer:
      "Oui, nous pouvons organiser des déménagements rapides selon vos disponibilités, avec une prise en charge 7j/7 en fonction des plannings.",
  },
  {
    question: "Est-ce que le devis de déménagement est gratuit ?",
    answer:
      "Oui, nous proposons un devis gratuit et personnalisé afin d'évaluer précisément vos besoins et le volume à déménager.",
  },
  {
    question: "Prenez-vous en charge l'emballage des objets fragiles ?",
    answer:
      "Oui, nous assurons la protection et l'emballage de vos biens fragiles avec du matériel adapté pour garantir leur sécurité.",
  },
  {
    question: "Proposez-vous le démontage et remontage des meubles ?",
    answer:
      "Oui, nos déménageurs s'occupent du démontage et du remontage de votre mobilier pour vous simplifier le déménagement.",
  },
  {
    question: "Avez-vous des solutions de stockage dans le Val-de-Marne ?",
    answer:
      "Oui, nous proposons des solutions de garde-meubles sécurisées pour stocker vos biens avant ou après votre déménagement.",
  },
  {
    question: "Comment se déroule la réservation d'un déménagement ?",
    answer:
      "Il suffit de nous contacter pour obtenir un devis. Une fois validé, nous planifions ensemble la date et l'organisation complète de votre déménagement.",
  },
] as const;

export default function DemenagementValDeMarne94() {
  usePageMeta(PAGE_META.demenagementValDeMarne94);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={VDM94_HERO_IMAGE}
              alt="Déménagement dans le Val-de-Marne — Guivarche"
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold tracking-wide text-white backdrop-blur-md shadow-lg">
                  ...
                  Val-de-Marne (94) • Toutes communes
                </div>
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Val-de-Marne – Des Pros Disponibles 7j/7 pour Vous
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Des professionnels disponibles 7j/7 pour votre déménagement dans le Val-de-Marne avec Guivarche
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur spécialisé dans le Val-de-Marne
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous envisagez un déménagement dans le Val-de-Marne ?{" "}
                  <a
                    href="/"
                  ...
                  vous accompagne pour organiser votre changement d&apos;adresse en toute sérénité, que vous habitiez
                  Créteil, Vincennes, Ivry-sur-Seine, Vitry-sur-Seine ou Champigny-sur-Marne.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre équipe prend en charge chaque étape : conditionnement de vos affaires, démontage du mobilier,
                  acheminement sécurisé de vos biens et installation dans votre nouveau domicile. Simplicité, efficacité
                  et tranquillité d&apos;esprit sont au cœur de notre démarche.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Le Val-de-Marne présente des réalités contrastées : quartiers denses en bords de Marne, zones
                  pavillonnaires calmes, accès parfois complexes en hypercentre ou encore contraintes liées à la
                  proximité de Paris. Ces spécificités nécessitent une préparation minutieuse en amont.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Grâce à notre expertise locale, nous anticipons chaque difficulté pour intervenir avec précision dans
                  l&apos;ensemble des communes du département.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, bénéficiez d&apos;un accompagnement sur-mesure et d&apos;un interlocuteur dédié tout
                  au long de votre déménagement dans le Val-de-Marne.
                </p>
              </div>
            </div>
            <div className="relative mx-auto h-[300px] w-full max-w-[360px] sm:h-[340px] sm:max-w-[400px] lg:mx-0 lg:h-full lg:max-w-none">
              <ValDeMarne94IntroImage />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement en Val-de-Marne
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Une formule complète pour un déménagement maîtrisé dans le Val-de-Marne, de votre logement actuel
            ...
            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {VDM94_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <ValDeMarne94PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {VDM94_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <ValDeMarne94PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        {renderCtaBand(
          "Devis déménagement en Val-de-Marne",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement dans le Val-de-Marne ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement dans le Val-de-Marne avec une protection complète de vos biens.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Val-de-Marne
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {VDM94_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={VDM94_DESTINATION_FAQ}
          compact
        />

        <InterventionMapValDeMarne94 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement dans le Val-de-Marne
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {VDM94_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < VDM94_IDF_ZONES.length - 1 ? (
