...
import { InterventionMapSeineSaintDenis93 } from "../components/intervention-map";
...
const SSD93_PRICING_FACTORS = [
  ...
  },
  {
    ...
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 93.",
  },
  {
...
const SSD93_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement en Seine-Saint-Denis.",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement en Seine-Saint-Denis (sous conditions)",
] as const;

/** Communes de la Seine-Saint-Denis — maillage interne. */
const SSD93_IDF_ZONES = [
  "Montreuil",
  "Aubervilliers",
  "Saint-Denis",
  "Bobigny",
...
const SSD93_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const SSD93_HERO_IMAGE = "/ville/denise.jpg";
const PRIMARY_CTA_LABEL = "Réservez aujourd'hui – Déménagement rapide dans le 93";

function SeineSaintDenis93IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={SSD93_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Seine-Saint-Denis"
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-['Poppins',sans-serif] text-base font-extrabold leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
                Déménagement en Seine-Saint-Denis
              </p>
...
function SeineSaintDenis93PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const SSD93_DESTINATION_FAQ = [
  {
    question: "Comment se déroule la préparation avant le déménagement ?",
    answer:
      "Après validation du devis, nous planifions ensemble les étapes et vous conseillons sur l'organisation afin d'optimiser le jour J.",
  },
  {
    question: "Est-ce que vous fournissez le matériel d'emballage ?",
    answer:
      "Oui, nous pouvons fournir cartons, protections et matériel adapté pour sécuriser vos biens avant le transport.",
  },
  {
    question: "Peut-on modifier la date du déménagement après réservation ?",
    answer:
      "Oui, la date peut être ajustée en fonction de nos disponibilités, en nous contactant le plus tôt possible.",
  },
  {
    question: "Intervenez-vous dans les zones à forte densité urbaine ?",
    answer:
      "Oui, nous avons l'habitude d'intervenir en Seine-Saint-Denis, même dans les zones très urbaines et les accès complexes.",
  },
  {
    question: "Est-ce que vous proposez des formules économiques ?",
    answer:
      "Oui, plusieurs formules sont disponibles afin de s'adapter à votre budget tout en garantissant un service de qualité.",
  },
  {
    question: "Que se passe-t-il en cas d'objets volumineux ou lourds ?",
    answer:
      "Nos équipes sont formées et équipées pour manipuler des meubles lourds ou encombrants en toute sécurité.",
  },
  {
    question: "Suis-je accompagné pendant toute l'opération ?",
    answer:
      "Oui, un interlocuteur dédié vous suit du début à la fin pour assurer une organisation claire et un déménagement sans stress.",
  },
] as const;

export default function DemenagementSeineSaintDenis93() {
  usePageMeta(PAGE_META.demenagementSeineSaintDenis93);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={SSD93_HERO_IMAGE}
              alt="Déménagement en Seine-Saint-Denis — Guivarche"
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold tracking-wide text-white backdrop-blur-md shadow-lg">
                  ...
                  Seine-Saint-Denis (93) • Toutes communes
                </div>
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Seine-Saint-Denis – Réservez Aujourd&apos;hui, Déménagez Sereinement
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Réservez dès aujourd&apos;hui et déménagez sereinement en Seine-Saint-Denis avec Guivarche
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur de confiance en Seine-Saint-Denis
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous préparez un déménagement en Seine-Saint-Denis ?{" "}
                  <a
                    href="/"
                  ...
                  est à vos côtés pour organiser votre projet de A à Z, que vous résidiez à Saint-Denis, Montreuil,
                  Aubervilliers, Aulnay-sous-Bois ou Bobigny.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Nous prenons en charge chaque aspect de votre déménagement : emballage soigneux, démontage et remontage
                  du mobilier, transport sécurisé et installation complète dans votre nouveau domicile. Notre objectif :
                  vous offrir une transition sereine et bien orchestrée.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  La Seine-Saint-Denis est un département dynamique aux défis bien réels : densité urbaine élevée,
                  immeubles collectifs imposants, accès restreints dans certains quartiers, trafic intense et diversité
                  architecturale marquée. Chaque déménagement y exige anticipation et réactivité.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre expérience du terrain en Seine-Saint-Denis nous permet d&apos;aborder chaque situation avec le bon
                  niveau de préparation et les ressources adaptées à votre projet.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, bénéficiez d&apos;une équipe fiable, réactive et à l&apos;écoute pour votre
                  déménagement en Seine-Saint-Denis.
                </p>
              </div>
            </div>
            <div className="relative mx-auto h-[300px] w-full max-w-[360px] sm:h-[340px] sm:max-w-[400px] lg:mx-0 lg:h-full lg:max-w-none">
              <SeineSaintDenis93IntroImage />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement Seine-Saint-Denis
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Profitez d&apos;un accompagnement complet pour votre déménagement en Seine-Saint-Denis, avec une
                organisation sur mesure conçue pour répondre aux exigences de votre quartier et garantir un transfert de
                vos biens en toute tranquillité.
              </p>
            </div>

            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {SSD93_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <SeineSaintDenis93PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {SSD93_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <SeineSaintDenis93PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        {renderCtaBand(
          "Devis déménagement Seine-Saint-Denis",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement en Seine-Saint-Denis ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement en Seine-Saint-Denis avec une protection complète de vos biens afin de garantir leur sécurité tout au long du déménagement.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Seine-Saint-Denis
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {SSD93_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={SSD93_DESTINATION_FAQ}
          compact
        />

        <InterventionMapSeineSaintDenis93 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement en Seine-Saint-Denis
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {SSD93_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < SSD93_IDF_ZONES.length - 1 ? (
