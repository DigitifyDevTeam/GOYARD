...
import { InterventionMapHautsDeSeine92 } from "../components/intervention-map";
...
const HDS92_PRICING_FACTORS = [
  ...
  },
  {
    ...
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 92.",
  },
  {
...
const HDS92_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement dans les Hauts-de-Seine",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement dans les Hauts-de-Seine (sous conditions)",
] as const;

/** Communes des Hauts-de-Seine — maillage interne (22 pages locales). */
const HDS92_IDF_ZONES = [
  "Neuilly-sur-Seine",
...
const HDS92_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const HDS92_HERO_IMAGE = "/ville/seine.webp";
const PRIMARY_CTA_LABEL = "Devis gratuit – On intervient dans tout le 92";

function HautsDeSeine92IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={HDS92_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Hauts-de-Seine"
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-['Poppins',sans-serif] text-base font-extrabold leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
                Déménagement en Hauts-de-Seine
              </p>
...
function HautsDeSeine92PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const HDS92_DESTINATION_FAQ = [
  {
    question: "Combien coûte un déménagement en Hauts-de-Seine ?",
    answer:
      "Le prix d'un déménagement dans les Hauts-de-Seine varie en moyenne entre 500 € et 2 800 €. Il dépend du volume à transporter, de l'accessibilité des logements, de la distance et des services choisis (emballage, démontage, monte-meuble, etc.). Un devis personnalisé est recommandé pour un tarif précis.",
  },
  {
    question: "Combien de temps dure un déménagement dans les Hauts-de-Seine ?",
    answer:
      "Un déménagement dans les Hauts-de-Seine dure généralement entre une demi-journée et une journée complète selon le volume et les conditions d'accès (étages, ascenseur, stationnement).",
  },
  {
    question: "Intervenez-vous dans toutes les communes des Hauts-de-Seine ?",
    answer:
      "Oui, nous intervenons dans l'ensemble du département : Boulogne-Billancourt, Nanterre, Courbevoie, Levallois-Perret, Issy-les-Moulineaux, Colombes, et toutes les autres communes du 92.",
  },
  {
    question: "Faut-il une autorisation de stationnement dans les Hauts-de-Seine ?",
    answer:
      "Dans certaines communes et zones urbaines denses, une autorisation de stationnement peut être nécessaire pour faciliter le chargement et le déchargement du camion. Nous pouvons vous accompagner dans cette démarche.",
  },
  {
    question: "Les biens sont-ils assurés pendant le déménagement ?",
    answer:
      "Oui, tous vos biens sont couverts par une assurance pendant toute la durée du déménagement, de la prise en charge jusqu'à la livraison dans votre nouveau logement.",
  },
  {
    question: "Proposez-vous des services de déménagement pour les entreprises ?",
    answer:
      "Oui, nous réalisons également des déménagements de bureaux et locaux professionnels dans tout le département des Hauts-de-Seine, avec une organisation adaptée pour limiter l'interruption d'activité.",
  },
  {
    question: "Quand faut-il réserver un déménagement dans les Hauts-de-Seine ?",
    answer:
      "Il est conseillé de réserver votre déménagement au moins 2 à 4 semaines à l'avance. En période de forte demande (été, fins de mois), une anticipation plus importante est recommandée.",
  },
] as const;

export default function DemenagementHautsDeSeine92() {
  usePageMeta(PAGE_META.demenagementHautsDeSeine92);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={HDS92_HERO_IMAGE}
              alt="Déménagement dans les Hauts-de-Seine — Guivarche"
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                ...
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Hauts-de-Seine – Rapide, Soigné et au Meilleur Prix
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Un déménagement simple, rapide et sécurisé dans les Hauts-de-Seine avec Guivarche
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur spécialisé dans les Hauts-de-Seine
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous planifiez un déménagement dans les Hauts-de-Seine ?{" "}
                  <a
                    href="/"
                  ...
                  met à votre disposition une équipe expérimentée pour assurer votre transition dans les meilleures
                  conditions, que vous résidiez à Boulogne-Billancourt, Nanterre, Issy-les-Moulineaux ou encore Colombes.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Nous gérons l&apos;intégralité de votre déménagement : emballage soigné, démontage du mobilier,
                  transport sécurisé et réinstallation dans votre nouveau logement. Notre priorité est de vous garantir
                  une expérience fluide et sans contrainte.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Déménager dans les Hauts-de-Seine implique de maîtriser des environnements variés : immeubles de
                  standing, résidences fermées, zones à fort trafic ou quartiers résidentiels pavillonnaires. Chaque
                  configuration demande une organisation spécifique et une logistique adaptée.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Fort de notre connaissance approfondie du département, nous anticipons chaque contrainte terrain pour
                  assurer une intervention rapide et efficace dans l&apos;ensemble des communes des Hauts-de-Seine.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, profitez d&apos;un interlocuteur unique et d&apos;un suivi personnalisé de A à Z pour
                  votre déménagement dans les Hauts-de-Seine.
                </p>
              </div>
            </div>
            <div className="relative mx-auto h-[300px] w-full max-w-[360px] sm:h-[340px] sm:max-w-[400px] lg:mx-0 lg:h-full lg:max-w-none">
              <HautsDeSeine92IntroImage />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement Hauts-de-Seine
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Une formule complète pour un déménagement maîtrisé dans les Hauts-de-Seine, de votre logement actuel
                jusqu&apos;à votre nouvelle adresse, avec une organisation rigoureuse adaptée aux contraintes de chaque
            ...
            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {HDS92_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <HautsDeSeine92PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {HDS92_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <HautsDeSeine92PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        {renderCtaBand(
          "Devis déménagement Hauts-de-Seine",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement dans les Hauts-de-Seine ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement dans les Hauts-de-Seine avec protection complète de vos biens.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Hauts-de-Seine
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {HDS92_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={HDS92_DESTINATION_FAQ}
          compact
        />

        <InterventionMapHautsDeSeine92 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement dans les Hauts-de-Seine
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {HDS92_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < HDS92_IDF_ZONES.length - 1 ? (
