...
import { InterventionMapSeineEtMarne77 } from "../components/intervention-map";
...
const SEM77_PRICING_FACTORS = [
  ...
  },
  {
    ...
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 77.",
  },
  {
...
const SEM77_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement en Seine-et-Marne.",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement en Seine-et-Marne (sous conditions)",
] as const;

/** Communes de la Seine-et-Marne — maillage interne. */
const SEM77_IDF_ZONES = [
  "Melun",
  "Chelles",
  "Meaux",
  "Pontault-Combault",
...
const SEM77_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const SEM77_HERO_IMAGE = "/ville/marne.avif";
const PRIMARY_CTA_LABEL = "Tarif fixe garanti – Devis sans engagement en Seine-et-Marne";

function SeineEtMarne77IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={SEM77_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Seine-et-Marne"
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-['Poppins',sans-serif] text-base font-extrabold leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
                Déménagement en Seine-et-Marne
              </p>
...
function SeineEtMarne77PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const SEM77_DESTINATION_FAQ = [
  {
    question: "Comment est calculé le tarif fixe de mon déménagement ?",
    answer:
      "Notre tarif fixe est établi après une évaluation précise de votre projet. Il prend en compte le volume à déménager, les accès aux logements, la distance et les prestations souhaitées afin de vous garantir un prix transparent.",
  },
  {
    question: "Proposez-vous des déménagements pour les appartements et les maisons ?",
    answer:
      "Oui, nous intervenons aussi bien pour les appartements que pour les maisons individuelles. Nous adaptons notre organisation en fonction de la configuration des lieux et des contraintes d'accès.",
  },
  {
    question: "Puis-je déménager le week-end ou pendant les vacances ?",
    answer:
      "Oui, nous proposons des créneaux flexibles selon les disponibilités de nos équipes. Nous pouvons organiser votre déménagement à la date qui vous convient le mieux, y compris pendant certaines périodes de forte demande.",
  },
  {
    question: "Disposez-vous du matériel nécessaire pour protéger mes meubles ?",
    answer:
      "Absolument. Nous utilisons des couvertures de protection, des housses, des sangles et des emballages spécifiques pour assurer la sécurité de vos meubles et objets fragiles pendant toute l'opération.",
  },
  {
    question: "Que faire si je ne peux pas emménager immédiatement dans mon nouveau logement ?",
    answer:
      "Nous pouvons vous accompagner avec des solutions de stockage temporaire afin de conserver vos biens dans des conditions sécurisées jusqu'à votre installation définitive.",
  },
  {
    question: "Votre équipe peut-elle gérer les objets lourds ou encombrants ?",
    answer:
      "Oui, nos déménageurs sont formés pour manipuler les meubles volumineux, l'électroménager, les équipements professionnels et les objets difficiles d'accès en toute sécurité.",
  },
  {
    question: "Quels sont les avantages de choisir une équipe professionnelle pour déménager en Seine-et-Marne ?",
    answer:
      "Une équipe professionnelle vous fait gagner du temps, réduit les risques de casse et assure une organisation efficace de votre déménagement. Vous bénéficiez ainsi d'un accompagnement fiable et d'une expérience sans stress du début à la fin.",
  },
] as const;

export default function DemenagementSeineEtMarne77() {
  usePageMeta(PAGE_META.demenagementSeineEtMarne77);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={SEM77_HERO_IMAGE}
              alt="Déménagement en Seine-et-Marne — Guivarche"
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold tracking-wide text-white backdrop-blur-md shadow-lg">
                  ...
                  Seine-et-Marne (77) • Toutes communes
                </div>
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Seine-et-Marne – Tarif Fixe, Équipe Sérieuse, Zéro Stress
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Un déménagement maîtrisé en Seine-et-Marne avec une équipe sérieuse et un tarif transparent
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur spécialisé en Seine-et-Marne
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous envisagez un déménagement en Seine-et-Marne ?{" "}
                  <a
                    href="/"
                  ...
                  vous accompagne avec sérieux et professionnalisme pour relever ce défi, que votre projet se situe à
                  Meaux, Melun, Chelles, Fontainebleau ou Provins.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre équipe assure une prestation complète : emballage sécurisé de vos affaires, démontage du
                  mobilier, transport avec soin et installation dans votre nouveau logement. Nous veillons à ce que
                  chaque étape se déroule sans accroc.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  La Seine-et-Marne, plus grand département d&apos;Île-de-France, présente des contraintes particulières :
                  longues distances à parcourir, routes départementales étroites, communes rurales difficiles d&apos;accès et
                  zones forestières enclavées. Une logistique bien rodée est indispensable.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Grâce à notre maîtrise du territoire seine-et-marnais, nous dimensionnons chaque intervention en
                  fonction des distances et des spécificités locales, pour un déménagement efficace et ponctuel.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, votre déménagement en Seine-et-Marne est entre des mains expertes, avec un suivi dédié
                  et une organisation pensée pour ce vaste département.
                </p>
              </div>
            </div>
            <div className="relative mx-auto h-[300px] w-full max-w-[360px] sm:h-[340px] sm:max-w-[400px] lg:mx-0 lg:h-full lg:max-w-none">
              <SeineEtMarne77IntroImage />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement Seine-et-Marne
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Une formule complète pour un déménagement maîtrisé en Seine-et-Marne, de votre logement actuel
                jusqu&apos;à votre nouvelle adresse, avec une organisation rigoureuse adaptée aux spécificités et aux
                contraintes de chaque commune du département.
              </p>
            </div>

            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {SEM77_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <SeineEtMarne77PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {SEM77_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <SeineEtMarne77PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        {renderCtaBand(
          "Devis déménagement Seine-et-Marne",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement en Seine-et-Marne ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement en Seine-et-Marne avec une protection complète de vos biens.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Seine-et-Marne
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {SEM77_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={SEM77_DESTINATION_FAQ}
          compact
        />

        <InterventionMapSeineEtMarne77 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement en Seine-et-Marne
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {SEM77_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < SEM77_IDF_ZONES.length - 1 ? (
