...
import { InterventionMapValDoise95 } from "../components/intervention-map";
...
const VDO95_PRICING_FACTORS = [
  ...
  },
  {
    ...
    label: "Distance",
    value: "Val-d'Oise",
    desc: "Distance et conditions de circulation et de stationnement selon les communes du 95.",
  },
  {
...
const VDO95_PRESTATIONS_INCLUDED = [
  ...
  "Stockage temporaire de vos biens avant ou après votre déménagement dans le Val-d'Oise.",
  "Assurance tous risques (option sur devis)",
  "Prix flexible (ajustable sur 5 jours)",
  "Démarches d'autorisation de stationnement dans le Val-d'Oise (sous conditions)",
] as const;

/** Communes du Val-d'Oise — maillage interne. */
const VDO95_IDF_ZONES = [
  "Cergy",
  "Argenteuil",
  "Pontoise",
  "Saint-Gratien",
...
const VDO95_INTRO_TRUCK_IMAGE = "/gallery/trucks.jpeg";
const VDO95_HERO_IMAGE = "/ville/valdoise.jpg";
/** Vertical crop anchor — higher % shows more ground (e.g. 18% = sky, 35% = ground). */
const VDO95_HERO_OBJECT_POSITION = "center 65%";
const PRIMARY_CTA_LABEL = "Réservez maintenant – Intervention rapide dans le Val-d'Oise";

function ValDoise95IntroImage() {
  return (
      ...
      <div className="relative z-10 h-full rounded-[24px] bg-gradient-to-br from-[#CC922F] via-[#e0b15f] to-[#1C3957] p-[3px] shadow-[0_30px_70px_-15px_rgba(28,57,87,0.45)]">
        <div className="h-full overflow-hidden rounded-[22px] bg-white">
          <div className="relative h-full">
            <img
              src={VDO95_INTRO_TRUCK_IMAGE}
              alt="Camion Guivarche Déménagement — Val-d'Oise"
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-['Poppins',sans-serif] text-base font-extrabold leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
                Déménagement dans le Val-d&apos;Oise
              </p>
...
function ValDoise95PrestationCard({ item }: Readonly<{ item: string }>) {
  return (
...
const VDO95_DESTINATION_FAQ = [
  {
    question: "Comment se déroule la première prise de contact ?",
    answer:
      "Vous nous contactez par téléphone ou via le formulaire en ligne. Nous évaluons vos besoins afin de vous proposer une solution adaptée à votre déménagement dans le Val-d'Oise.",
  },
  {
    question: "Dois-je être présent le jour du déménagement ?",
    answer:
      "Votre présence est recommandée pour faciliter les échanges, mais nous pouvons également nous adapter si vous n'êtes pas disponible sur place.",
  },
  {
    question: "Comment est calculé le prix d'un déménagement ?",
    answer:
      "Le tarif dépend du volume à transporter, de la distance, de l'accessibilité des lieux et des services choisis (emballage, montage, stockage…).",
  },
  {
    question: "Intervenez-vous aussi pour les entreprises ?",
    answer:
      "Oui, nous réalisons également des déménagements professionnels pour bureaux, commerces et locaux d'activité dans le Val-d'Oise.",
  },
  {
    question: "Que faire en cas d'accès difficile (sans ascenseur, rue étroite) ?",
    answer:
      "Nos équipes sont habituées à ce type de contraintes et utilisent le matériel adapté pour assurer un déménagement sécurisé.",
  },
  {
    question: "Combien de temps faut-il pour organiser un déménagement ?",
    answer:
      "Cela dépend de votre situation, mais nous pouvons organiser une intervention rapidement, parfois en quelques jours selon la disponibilité.",
  },
  {
    question: "Proposez-vous un accompagnement après le déménagement ?",
    answer:
      "Oui, nous restons disponibles après l'intervention pour toute question ou besoin complémentaire lié à votre installation.",
  },
] as const;

export default function DemenagementValDoise95() {
  usePageMeta(PAGE_META.demenagementValDoise95);
      ...
      <main>
        ...
        <section className="relative overflow-hidden min-h-[460px] lg:min-h-[520px]">
          <div className="absolute inset-0" aria-hidden="true">
            <img
              src={VDO95_HERO_IMAGE}
              alt="Déménagement dans le Val-d'Oise — Guivarche"
              className="absolute inset-0 h-full w-full object-cover"
              style={{ objectPosition: VDO95_HERO_OBJECT_POSITION }}
            />
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
              <div className="relative lg:col-span-7">
                ...
                <h1 className="mt-5 font-['Poppins',sans-serif] font-extrabold tracking-tight text-white text-3xl sm:text-4xl lg:text-5xl leading-tight [text-shadow:0_2px_16px_rgba(0,0,0,0.55)]">
                  Déménagement en Val-d&apos;Oise – Rapide, Pas Cher et Sans Stress Garanti
                </h1>
                <p className="mt-4 text-[#f1f5f9] text-base sm:text-lg leading-relaxed max-w-2xl font-medium [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_2px_12px_rgba(0,0,0,0.65)]">
                  Des professionnels disponibles 7j/7 pour votre déménagement dans le Val-d&apos;Oise avec Guivarche
                </p>
            ...
            <div>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
                  Guivarche, votre déménageur spécialisé dans le Val-d&apos;Oise
                </h2>
              </div>
              <div className="mt-4 sm:mt-5 space-y-4">
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Vous planifiez un déménagement dans le Val-d&apos;Oise ?{" "}
                  <a
                    href="/"
                  ...
                  vous propose un accompagnement complet et rigoureux pour changer d&apos;adresse en toute quiétude,
                  que vous viviez à Cergy, Pontoise, Argenteuil, Sarcelles ou Osny.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Nos équipes interviennent sur l&apos;ensemble des étapes : protection et emballage de vos biens,
                  démontage du mobilier, transport sécurisé et remise en place dans votre futur logement. Notre
                  engagement : zéro stress, zéro mauvaise surprise.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Le Val-d&apos;Oise conjugue zones urbaines densément peuplées, quartiers résidentiels en plein essor
                  et secteurs ruraux plus isolés. Cette diversité territoriale exige une capacité d&apos;adaptation et
                  une parfaite maîtrise logistique pour chaque intervention.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Notre implantation dans le département nous permet d&apos;anticiper les contraintes spécifiques à
                  chaque commune et d&apos;assurer une organisation irréprochable sur l&apos;ensemble du Val-d&apos;Oise.
                </p>
                <p className="font-['Poppins',sans-serif] text-slate-700 text-base sm:text-lg leading-relaxed">
                  Avec Guivarche, chaque déménagement dans le Val-d&apos;Oise bénéficie d&apos;un encadrement
                  professionnel et d&apos;un suivi personnalisé, du premier contact jusqu&apos;à l&apos;installation finale.
                </p>
              </div>
            </div>
            <div className="relative mx-auto h-[300px] w-full max-w-[360px] sm:h-[340px] sm:max-w-[400px] lg:mx-0 lg:h-full lg:max-w-none">
              <ValDoise95IntroImage />
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl leading-tight">
                Nos prestations incluses pour votre déménagement Val-d&apos;Oise
              </h2>
              <p className="mt-4 font-['Poppins',sans-serif] text-slate-500 text-base sm:text-lg leading-relaxed">
                Une formule complète pour un déménagement maîtrisé dans le Val-d&apos;Oise, de votre logement actuel
            ...
            <div className="mt-10 sm:mt-12 max-w-6xl mx-auto space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                {VDO95_PRESTATIONS_INCLUDED.slice(0, -3).map((item) => (
                  <ValDoise95PrestationCard key={item} item={item} />
                ))}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:mx-auto lg:max-w-[75%]">
                {VDO95_PRESTATIONS_INCLUDED.slice(-3).map((item) => (
                  <ValDoise95PrestationCard key={item} item={item} />
                ))}
              </div>
            </div>
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="font-['Poppins',sans-serif] font-extrabold text-[#191919] text-2xl sm:text-3xl">
              Comment se déroule votre déménagement dans le Val-d&apos;Oise ?
            </h2>
          </div>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Notre équipe assure le chargement dans le Val-d'Oise avec une protection complète de vos biens.",
              },
              {
                step: "Étape 4",
                title: "Livraison",
        ...
        <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px] py-12 sm:py-14 lg:py-16 bg-white">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-2xl sm:text-3xl lg:text-4xl">
              Prix d&apos;un déménagement Val-d&apos;Oise
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-14 sm:mb-16">
              {VDO95_PRICING_FACTORS.map((card) => (
                <div
                  key={card.label}
        ...
        <DestinationFaqSection
          title="FAQ"
          items={VDO95_DESTINATION_FAQ}
          compact
        />

        <InterventionMapValDoise95 />
        ...
        <section className="bg-white border-t border-slate-100 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-[90px] xl:px-[210px]">
            <h2 className="font-['Poppins',sans-serif] font-bold text-[#1C3957] text-xl sm:text-2xl lg:text-3xl text-center uppercase tracking-[0.12em] sm:tracking-[0.16em]">
              Nos zones d&apos;intervention pour votre déménagement en Val-d&apos;Oise
            </h2>
            <div className="mt-12 sm:mt-14 max-w-6xl mx-auto text-center">
              <p className="font-['Poppins',sans-serif] text-slate-600 text-base sm:text-lg leading-[2.4] sm:leading-[2.6]">
                {VDO95_IDF_ZONES.map((city, index) => (
                  <span key={city}>
                    <Sparkles
                    ...
                    {index < VDO95_IDF_ZONES.length - 1 ? (
