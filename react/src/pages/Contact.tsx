                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="flex items-start space-x-4 sm:space-x-5 p-5 sm:p-8 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <a href="mailto:donec@guivarche-demenagement.fr" className="text-gray-600 text-lg hover:text-[#CC922F] transition-colors font-['Poppins',sans-serif]">
                        donec@guivarche-demenagement.fr
                      </a>
                    </div>
                  </div>
                  ...
                  {/* LinkedIn */}
                  <div className="flex items-start space-x-4 sm:space-x-5 p-5 sm:p-8 bg-gray-50 rounded-xl hover:shadow-md transition-shadow cursor-pointer">
