...
export default function Footer() {
  useEffect(() => {
    ...
    script.onload = () => {
      // Widget script only runs on window "load"; if we inject late, that already fired.
      const g = globalThis as unknown as { GrwWidgetLoader?: () => void };
      if (document.readyState === "complete" && typeof g.GrwWidgetLoader === "function") {
        g.GrwWidgetLoader();
      }
    };
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-base lg:text-[17px] tracking-[-0.2px]">
              ...
              <div className="flex flex-col gap-3 items-start">
                ...
                <div
                  className="review-widget_net max-w-full"
                  data-uuid="d8772079-feb2-4f0a-8c70-fd6f2b4d8945"
                  data-template="10"
                  data-lang="fr"
                  data-theme="dark"
                >
