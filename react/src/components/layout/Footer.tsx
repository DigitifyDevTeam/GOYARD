      ...
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="https://www.linkedin.com/company/guivarche-d%C3%A9m%C3%A9nagement/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" aria-label="LinkedIn">
